				...
				<div class="col-md card card-body py-5">
					...
					<div class="row m-5">
						<div class="col-2 text-center">
							<a
								href="StaffController?action=staffHome&staffICNumber=<c:out value="${staff.staffICNumber}"/>">
					...
					<div class="row m-3">
						...
						<div class="col-8">
							<input type="text" name="staffName" id="" class="form-control"
								value="<c:out value="${staff.staffName}"/>" disabled>
						</div>
					</div>
					...
					<div class="row m-3">
						...
						<div class="col-8">
							<input type="text" name="staffICNumber" id=""
								class="form-control"
								value="<c:out value="${staff.staffICNumber}"/>" disabled>
						</div>
					</div>
					...
					<div class="row m-3">
						...
						<div class="col-8">
							<input type="text" name="staffAddress" id="" class="form-control"
								value="<c:out value="${staff.staffAddress}"/>" disabled>
						</div>
					</div>
					...
					<div class="row m-3">
						...
						<div class="col-8">
							<input type="text" name="staffGender" id="" class="form-control"
								value="<c:out value="${staff.staffGender}"/>" disabled>
						</div>
					</div>
					...
					<div class="row m-3">
						...
						<div class="col-8">
							<input type="text" name="staffRace" id="" class="form-control"
								value="<c:out value="${staff.staffRace}"/>" disabled>
						</div>
					</div>
					...
					<div class="row m-3">
						...
						<div class="col-8">
							<input type="text" name="staffReligion" id=""
								class="form-control"
								value="<c:out value="${staff.staffReligion}"/>" disabled>
						</div>
					</div>
					...
					<div class="row m-3">
						...
						<div class="col-8">
							<input type="text" name="staffMaritalStatus" id=""
								class="form-control"
								value="<c:out value="${staff.staffMaritalStatus}"/>" disabled>
						</div>
					</div>
					...
					<div class="row m-3">
						...
						<div class="col-8">
							<input type="text" name="staffRole" id="" class="form-control"
								value="<c:out value="${staff.staffRole}"/>" disabled>
						</div>
					</div>
					...
					<div class="row m-3">
						...
						<div class="col-8">
							<input type="text" name="staffPhoneNumber" id=""
								class="form-control"
								value="<c:out value="${staff.staffPhoneNumber}"/>" disabled>
						</div>
					</div>
					...
					<div class="row m-3">
						...
						<div class="col-8">
							<input type="text" name="staffPassword" id=""
								class="form-control"
								value="<c:out value="${staff.staffPassword}"/>" disabled>
						</div>
					</div>
					...
					<div class="row m-5">
						...
						<div class="col">
							<a
								href="StaffController?action=staffUpdateV&staffICNumber=<c:out value="${staff.staffICNumber}"/>"
