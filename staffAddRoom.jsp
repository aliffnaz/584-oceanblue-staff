							...
							<div class="col-8">
								<div class="qty-buttons mb-3 version_2">
									<input type="button" value="+" class="qtyplus"
										name="adult_staff_addroom"> <input type="text"
										value="0" class="qty form-control" name="maxGuest"> <input
										type="button" value="-" class="qtyminus"
										name="adult_staff_addroom">
								</div>
							</div>
						</div>
						<div class="row m-3">
							...
							<div class="col-8">
								<input type="text" name="roomRate" class="form-control"
									placeholder="80">
							</div>
						</div>
						<div class="row m-3">
							...
							<div class="col-8">
								<div class="custom_select">
									<select name="roomType" class="wide">
