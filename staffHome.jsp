...
<body class="datepicker_mobile_full">
	...
	<div class="nav_panel">
		...
		<div class="sidebar-navigation">
			<nav>
				<ul class="level-1">
					<li class=""><a href=""><i class="bi bi-house"
							style="font-size: 25px;"></i> &nbsp; Home</a></li>
					<li><a
						href="StaffController?action=staffProfile&staffICNumber=<c:out value="${staff.staffICNumber}"/>"><i
							class="bi bi-person-check" style="font-size: 25px;"></i> &nbsp;
							View Profile</a></li>
					<li><a href="RoomController?action=StaffRoomList"><i
							class="bi bi-clipboard-check" style="font-size: 25px;"></i>
							&nbsp; Manage Room</a></li>
					<li><a
						href="ReservationController?action=StaffReservationList"><i
							class="bi bi-view-list" style="font-size: 25px;"></i> &nbsp;
							Reservation List</a></li>
					<li><a href="StaffController?action=staffGuestList"><i
