					...
					<div class="row m-3">
						...
						<div class="col-8">
							<input type="text" name="roomNum" id="" class="form-control"
								value="<c:out value="${room.roomNum}"/>" disabled>
						</div>
					</div>
					<div class="row m-3">
						<div class="col-1"></div>
						...
						<div class="col-8">
							<input type="text" name="maxGuest" id="" class="form-control"
								value="<c:out value="${room.maxGuest}"/>" disabled>
						</div>
					</div>
					<div class="row m-3">
						<div class="col-1"></div>
						...
						<div class="col-8">
							<input type="text" name="roomRate" id="" class="form-control"
								value="<c:out value="${room.roomRate}"/>" disabled>
						</div>
					</div>
					<div class="row m-3">
						<div class="col-1"></div>
						...
						<div class="col-8">
							<input type="text" name="roomType" id="" class="form-control"
								value="<c:out value="${room.roomType}"/>" disabled>
						</div>
					</div>
					<div class="row m-3">
						<div class="col-1"></div>
						...
						<div class="col-8">
							<input type="text" name="roomSize" id="" class="form-control"
								value="<c:out value="${room.roomSize}"/>" disabled>
						</div>
					</div>
					<div class="row m-3">
						<div class="col-1"></div>
						...
						<div class="col-8">
							<input type="text" name="roomStatus" id="" class="form-control"
								value="<c:out value="${room.roomStatus}"/>" disabled>
						</div>
					</div>
					<div class="row m-5">
						<div class="col text-center">
							<a
								href="RoomController?action=staffUpdateRoomV&roomNum=<c:out value="${room.roomNum}"/>"
