        ...
        <div class="sidebar-navigation">
            <nav>
                <ul class="level-1">
                    ...
                    <li><a href="staffGuestList.html"><i class="bi bi-people" style="font-size: 25px;" ></i> 
                            &nbsp; Manage Guest</a></li>
                    <li><a href="staffGenerateReport.html"><i class="bi bi-file-earmark-bar-graph"
                ...
                <div class="col-md card card-body py-5">
                    ...
                    <div class="row m-5">
                        ...
                        <div class="col-6 text-center">
                            <a href="staffProfile.html" class="btn btn-dark btn-md"
                            ...
                            <a href="staffProfile.html" class="btn btn-danger btn-md"
